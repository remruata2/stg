      ...
      <ToastProvider>
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex w-full">
          ...
          <div className="flex flex-col flex-1 w-full">
            <div className="sticky top-0 z-50 bg-gray-100 dark:bg-gray-900 lg:hidden">
              <div className="flex h-16 items-center px-4">
                <button
                  type="button"
                  className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
