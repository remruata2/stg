...
export default function EditGuidelinePage({ params }: RouteParams) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const guidelineResponse = await fetch(`/api/guidelines/${params.id}`)
  ...
  const handleSubmit = async (formData: {
    ...
    try {
      const response = await fetch(`/api/guidelines/${params.id}`, {
        method: 'PUT',
        headers: {
