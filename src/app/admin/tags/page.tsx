  ...
  return (
    <div className="space-y-6">
      ...
      {showEditModal && currentTag && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">Edit Tag</h2>
      ...
      {showDeleteModal && currentTag && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">Delete Tag</h2>
            <p className="text-sm text-gray-500">
              ...
              {currentTag._count && currentTag._count.guidelines > 0 && (
                <span className="block mt-2 text-red-500 font-medium">
                  Warning: This tag is used in {currentTag._count.guidelines} guidelines. Deleting it will remove the tag from all guidelines.
                </span>
              )}
            </p>
            <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
