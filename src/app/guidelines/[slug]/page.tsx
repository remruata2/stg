	...
	return (
		<div className="flex flex-col lg:flex-row gap-8">
			...
			<div className="lg:w-64 flex-shrink-0">
				<div className="bg-white shadow rounded-lg p-4 sticky top-4">
					...
					<nav className="space-y-1">
						<a
							href="#overview"
							className="block px-3 py-2 text-sm rounded-md text-gray-900 bg-gray-100 font-medium"
						>
							Overview
						</a>
						<a
							href="#treatment"
							className="block px-3 py-2 text-sm rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900"
						>
							Treatment
						</a>
						<a
			...
			<div className="flex-1 w-full flex flex-col">
				<div className="bg-white shadow rounded-lg p-6 self-stretch">
