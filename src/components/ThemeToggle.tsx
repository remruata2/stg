	...
	if (variant === "navbar") {
		return (
			<button
				...
				className="p-2 rounded-md text-gray-300 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
				title={
