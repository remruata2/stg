...
export default function NavBar() {
  ...
  return (
    <nav className="bg-blue-600 dark:bg-gray-900 shadow-sm">
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link
                href="/"
                className="font-bold text-xl text-white dark:text-blue-400"
              >
                STG Mizoram
              </Link>
            </div>
              ...
              <Link
                ...
                className={`${
                  pathname.startsWith("/categories")
                    ? "border-blue-500 text-white dark:text-gray-100"
                    : "border-transparent text-white dark:text-gray-400 hover:border-gray-300  hover:bg-blue-700 dark:hover:border-gray-600 hover:text-white dark:hover:text-white"
          ...
          <div className="pt-4 pb-3 border-t border-gray-200 dark:border-gray-700">
            ...
            {status === "authenticated" ? (
              <div className="flex items-center px-4 space-x-4 mt-4">
                ...
                <button
                  onClick={handleSignOut}
                  className="ml-auto bg-white dark:bg-gray-800 p-1 rounded-full text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                >
