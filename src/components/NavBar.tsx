...
export default function NavBar() {
	...
	return (
		<nav className="bg-blue-900 dark:bg-gray-800 shadow-sm">
							...
							<Link
								...
								className={`${
									pathname.startsWith("/categories")
										...
										: "border-transparent text-white dark:text-gray-400 hover:border-gray-300   dark:hover:border-gray-600 hover:text-white dark:hover:text-white"
